...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Identifier ctermbg=NONE ctermfg=NONE cterm=underline,bold guibg=NONE guifg=NONE gui=bold
    ...
    hi Underlined ctermbg=NONE ctermfg=NONE cterm=underline guibg=NONE guifg=NONE
    hi StatusLine ctermbg=NONE ctermfg=NONE cterm=reverse guibg=NONE guifg=NONE gui=reverse
    hi StatusLineNC ctermbg=NONE ctermfg=NONE cterm=underline guibg=NONE guifg=NONE
